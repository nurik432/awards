...
const CONTENT_SECTIONS = [
  ...
  {
    id: 'process',
    label: '⚙️ Секция «Процесс»',
    description: 'Блок «Как устроен процесс оценки» — заголовки, шаги и список функций.',
    fields: [
      { key: 'process_kicker', label: 'Подзаголовок (kicker)', placeholder: 'Прозрачная модель' },
      { key: 'process_title', label: 'Заголовок', placeholder: 'Как устроен процесс оценки' },
      { key: 'process_step_1', label: 'Шаг 1', placeholder: 'Номинации и условия участия объявляются заранее для всех сотрудников.' },
      { key: 'process_step_2', label: 'Шаг 2', placeholder: 'По каждой номинации определяются критерии, источник данных и этапы рассмотрения.' },
      { key: 'process_step_3', label: 'Шаг 3', placeholder: 'Комиссия проводит оценку на основе KPI, форм, опросов 360, экспертных мнений и внутренних данных.' },
      { key: 'process_step_4', label: 'Шаг 4', placeholder: 'По итогам публично озвучивается причина выбора победителей.' },
      { key: 'process_panel_title', label: 'Заголовок правой панели', placeholder: 'Что уже добавлено' },
      { key: 'process_feature_1', label: 'Пункт 1', placeholder: 'Страница победителей 2025 года с полным списком' },
      { key: 'process_feature_2', label: 'Пункт 2', placeholder: 'Онлайн-форма подачи заявок' },
      { key: 'process_feature_3', label: 'Пункт 3', placeholder: 'Поиск и фильтр по номинациям' },
      { key: 'process_feature_4', label: 'Пункт 4', placeholder: 'Готовая структура для подключения отправки заявок' },
      { key: 'process_feature_5', label: 'Пункт 5', placeholder: 'Удобное раскрытие списков по каждой номинации' },
    ],
  },
  {
    id: 'footer',
